...
export class DashboardViewService {
    ...
    constructor() {
        ...
        if (!this.PotentialBuyers) {
            ...
            let arr = [{"fullName":"david Cohen","gender":"male","email":"david@Cohen","birthDate":"2006-10-09T22:00:00.000Z","hobbies":["painting","swimming","singing","hiking"],"color":"#f82525","amountSeats":4,"motorType":"electric","location":"מודיעין עילית"},{"fullName":"aa aa","gender":"female","email":"aa@aa","birthDate":"2006-10-10T22:00:00.000Z","hobbies":["painting","swimming","cooking"],"color":"#639cbf","amountSeats":4,"motorType":"electric","location":"אשוויל, צפון קרוליינה, ארצות הברית"},{"fullName":"bb bbb","gender":"male","email":"bb@bb","birthDate":"2016-06-06T21:00:00.000Z","hobbies":["swimming","singing","playing computer games"],"color":"#b7b927","amountSeats":3,"motorType":"fuel","location":"Deen Dayal Nagar, Gwalior, Madhya Pradesh, הודו"},{"fullName":"אלישבע סירוקה","gender":"female","email":"e0533169098@gmail.com","birthDate":"2019-11-19T22:00:00.000Z","hobbies":["painting","baking"],"color":"#c14fc9","amountSeats":4,"motorType":"electric","location":"ירושלים, ישראל"},{"fullName":"sdsds","gender":"female","email":"dd@ss","birthDate":"2017-01-31T22:00:00.000Z","hobbies":["swimming","singing","dancing"],"color":"#0b1228","amountSeats":[null],"motorType":"fuel","location":"תל אביב יפו, ישראל"},{"fullName":"ggf","gender":"female","email":"dd@ss","birthDate":"2017-01-31T22:00:00.000Z","hobbies":["swimming","playing golf","cooking"],"color":"#d0b949","amountSeats":4,"motorType":"electric","location":"תל אביב יפו, ישראל"}]
